    ...
    <body>
        ...
        <div class="left">
            ...
            <div class="right">
                    ...
                    <br>
                    <h2 style="background-color:#8a8585">Home > Students</h2>
                    <div class="box">
                        <button style="width: 300px; height:40px; font-size:20px"><img src="" alt="" width="20px" height="20px">&nbsp;&nbsp; All Students</button>
                        <a href="a_add_students.php"><button style="width: 300px; height:40px; font-size:20px"><img src="" alt="" width="20px" height="20px"> Add Students</button></a>
                        ...
                        <caption><b style="color: blue; font-size:30px">Registered Students</b></caption>
                            <thead>
